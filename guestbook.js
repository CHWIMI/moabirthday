...
const ADMIN_UIDS = ["A9a96wJRgidw9jXUy2B4GhtmDsB2", "u8zt3TZGJ6MY5GAUB0az2zay4BP2", "kF24F9xGncYFhrqlKAVzsLUK39J2"]; // 관리자 구글 UID를 여기에 입력
...
onAuthStateChanged(auth, (user) => {
    ...
    if (googleLoginBtn && user) {
        if (!user.isAnonymous) {
            googleLoginBtn.innerHTML = '<img src="https://www.gstatic.com/firebasejs/ui/2.0.0/images/auth/google.svg" alt="Google" style="width: 18px; height: 18px;">구글 로그아웃';
            ...
            googleLoginBtn.innerHTML = '<img src="https://www.gstatic.com/firebasejs/ui/2.0.0/images/auth/google.svg" alt="Google" style="width: 18px; height: 18px;">구글 연동';
